...
namespace csms_backend.Controllers
{
    public class BusinessUnitService : BaseService, BusinessUnitInterface
    {
        ...
        public BusinessUnitService(Context context, IMapper mapper, BusinessUnitQuery buQuery) : base(context, mapper)
        {
            _buQuery = buQuery;
        }
            ...
            string? searchTerm)
        {
            ...
            return await PaginationHelper.PaginateAndMap<BusinessUnit, BusinessUnitResponse>(query, pageNumber, pageSize, _mapper);
        }
